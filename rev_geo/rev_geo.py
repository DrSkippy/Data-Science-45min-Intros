...
def topic_args():
    ...
    parser.add_argument("-b"
            ...
            , help="bounding box for region to include")
    parser.add_argument("-d"
            , "--delta"
            , dest="delta"
            , default=5
            , help="the number of degrees between grid coords (default 5)")
    parser.add_argument("-s"
            , "--shape-file-path"
            , dest="shape_file_path"
            , default="data/tl_2013_us_county.shp"
            , help="shape file path (default: data/tl_2013_us_county.shp)")
    parser.add_argument("-t"
            , "--tweet-input"
            , dest="tweet_input"
            , default=False, action="store_true"
            , help="For input being tweets instead of coordinates")
    return parser
